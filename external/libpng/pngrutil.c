...
extern void png_read_filter_row_neon(png_size_t rowbytes, png_byte pixel_depth, png_bytep row, png_const_bytep prev_row, int filter);
...
png_crc_error(png_structrp png_ptr)
{
   ...
   if((png_ptr->chunk_name == png_IDAT) && (png_ptr->is_decode_subset == 1)){
...
#if defined(__ARM_HAVE_NEON_COMMON) //32bit and 64bit.
